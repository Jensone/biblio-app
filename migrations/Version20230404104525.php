...
final class Version20230404104525 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE book (id INT AUTO_INCREMENT NOT NULL, isbn INT NOT NULL, title VARCHAR(150) NOT NULL, description VARCHAR(255) NOT NULL, author VARCHAR(255) NOT NULL, publication DATE NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
